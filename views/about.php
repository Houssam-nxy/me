					...
					<div class="fixed right-0 z-10 w-full h-full duration-300 ease-in-out transform translate-x-full top-24">
						...
						<nav class="fixed h-full mt-8">
							<div class="px-12 py-4">
								<a rel="noopener noreferrer" href="#" class="text-2xl font-bold tracking-widest text-gray-900">Blog</a>
							</div>
							<div class="px-12 py-4">
								<a rel="noopener noreferrer" href="#" class="text-2xl font-bold tracking-widest text-gray-900">Tags</a>
							</div>
							<div class="px-12 py-4">
								<a rel="noopener noreferrer" href="#" class="text-2xl font-bold tracking-widest text-gray-900">Projects</a>
							</div>
							<div class="px-12 py-4">
								<a rel="noopener noreferrer" href="#" class="text-2xl font-bold tracking-widest text-gray-900">About</a>
							</div>
						</nav>
					</div>
				</div>
					...
					<li>
						<article>
							...
							<div class="space-y-1">
								...
								<p class="max-w-full text-gray-100 prose prose-invert">Qui ei agam assum vivendum, ad nostro mediocrem sit, erant sanctus maiestatis vel no. Reque periculis usu at, id mel dicam impetus aliquip. At discere feugiat qui, meliore lucilius persecuti ut pri, vivendo corpora ne sit.</p>
					...
					<li>
						<article>
							...
							<div class="space-y-1">
								...
								<p class="max-w-full text-gray-100 prose prose-invert"> Vero facete sea ne. Ludus saperet scriptorem no usu. Legere intellegam delicatissimi te sit. Vis te oporteat deterruisset.</p>
								<div class="flex flex-wrap space-x-3">
									<a rel="noopener noreferrer" href="#" class="text-xs text-violet-400">#angular</a>
									<a rel="noopener noreferrer" href="#" class="text-xs text-violet-400">#tailwind</a>
									<a rel="noopener noreferrer" href="#" class="text-xs text-violet-400">#webdev</a>
					...
					<li>
						<article>
							...
							<div class="space-y-1">
								...
								<p class="max-w-full text-gray-100 prose prose-invert">Duo ei paulo decore periculis, sed ex hinc inermis vivendo, meis feugait no mea. Pri magna commodo urbanitas cu, id eos lorem inimicus prodesset. Cu qui vidisse epicurei accusamus.</p>
								<div class="flex flex-wrap space-x-3">
									<a rel="noopener noreferrer" href="#" class="text-xs text-violet-400">#angular</a>
									<a rel="noopener noreferrer" href="#" class="text-xs text-violet-400">#tailwind</a>
									<a rel="noopener noreferrer" href="#" class="text-xs text-violet-400">#webdev</a>
			...
			<div class="space-y-6">
				...
				<div class="grid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-2">
					<a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum" class="flex flex-col bg-gray-900">
						<img alt="" class="object-cover w-full bg-gray-500 h-52" src="https://source.unsplash.com/200x200/?fashion?1">
					</a>
					...
					<a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum" class="flex flex-col bg-gray-900">
						<img alt="" class="object-cover w-full bg-gray-500 h-52" src="https://source.unsplash.com/200x200/?fashion?2">
					</a>
					<div class="flex flex-col flex-1 p-6">
						<a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum" class="flex flex-col bg-gray-900"></a>
						<a rel="noopener noreferrer" href="#" class="text-xs tracking-wider uppercase hover:underline text-violet-400">Convenire</a>
					...
					<a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum" class="flex flex-col bg-gray-900">
						<img alt="" class="object-cover w-full bg-gray-500 h-52" src="https://source.unsplash.com/200x200/?fashion?3">
					</a>
					<div class="flex flex-col flex-1 p-6">
						<a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum" class="flex flex-col bg-gray-900"></a>
						<a rel="noopener noreferrer" href="#" class="text-xs tracking-wider uppercase hover:underline text-violet-400">Convenire</a>
					...
					<a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum" class="flex flex-col bg-gray-900">
						<img alt="" class="object-cover w-full bg-gray-500 h-52" src="https://source.unsplash.com/200x200/?fashion?4">
					</a>
					<div class="flex flex-col flex-1 p-6">
						<a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum" class="flex flex-col bg-gray-900"></a>
						<a rel="noopener noreferrer" href="#" class="text-xs tracking-wider uppercase hover:underline text-violet-400">Convenire</a>
